    ...
    <form className={classes.form} onSubmit={confirmHandler}>
      <div
        className={`${classes.control} ${
          formInputValidity.name ? "" : classes.notValid
        }`}
      >
      ...
      <div
        className={`${classes.control} ${
          formInputValidity.address ? "" : classes.notValid
        }`}
      >
      ...
      <div
        className={`${classes.control} ${
          formInputValidity.postalCode ? "" : classes.notValid
        }`}
      >
      ...
      <div
        className={`${classes.control} ${
          formInputValidity.city ? "" : classes.notValid
        }`}
      >
