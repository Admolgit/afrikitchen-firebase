...
function Cart(props) {
  ...
  const submitOrderHandler = async (userData) => {
    ...
    await fetch(
      "https://afrikitchen-bc387-default-rtdb.firebaseio.com/orders.json",
      {
        method: "POST",
        body: JSON.stringify({
          user: userData,
  ...
  const didSubmitModalContent = (
    <React.Fragment>
      <p>
        Your order has been submitted successfully, your meal will be deliver to
        the entered address when it is ready.
      </p>
